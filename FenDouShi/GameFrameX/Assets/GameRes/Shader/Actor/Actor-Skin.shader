Shader "R2/Actor/Actor-Skin"
{
    Properties
    {
        ...
        [Toggle(_FACE_ON)]_FaceOn("脸-模式", Float) = 0.0
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Actor-Skin-Input.hlsl"
            #include "Actor-Skin-Pass.hlsl"
        ...
        Pass
        {
            ...
            #include "Actor-Skin-Input.hlsl"
            #include "Actor-Skin-Outline.hlsl"
