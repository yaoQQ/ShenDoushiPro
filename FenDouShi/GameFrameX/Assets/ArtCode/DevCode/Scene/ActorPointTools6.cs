...
public class ActorPointTools6 : MonoBehaviour
{
    ...
    public Vector3 sing_7 = new Vector3();
    [OnValueChanged("LogicPoint"), LabelText("8")]
    public Vector3 sing_8 = new Vector3();
    [OnValueChanged("LogicPoint"), LabelText("9")]
    public Vector3 sing_9 = new Vector3();
    [OnValueChanged("LogicPoint"), LabelText("10")]
    public Vector3 sing_10 = new Vector3();
    [OnValueChanged("LogicPoint"), LabelText("11")]
    public Vector3 sing_11 = new Vector3();
    [OnValueChanged("LogicPoint"), LabelText("12")]
    public Vector3 sing_12 = new Vector3();
    ...
    public void CreateObjFlipBtn()
    {
        for (int i = 0; i < actorPoints.Count; i++)
        {
            ...
            var actorPrefab = actorPrefabs.Count > i ? actorPrefabs[(i + POINT_COUNT/2)% POINT_COUNT] : null;
    ...
    public void LogicPoint()
    {
        ...
        actorPoints[6].localPosition += new Vector3(sing_7.x, sing_7.y, sing_7.z);
        actorPoints[7].localPosition += new Vector3(sing_8.x, sing_8.y, sing_8.z);
        actorPoints[8].localPosition += new Vector3(sing_9.x, sing_9.y, sing_9.z);
        actorPoints[9].localPosition += new Vector3(sing_10.x, sing_10.y, sing_10.z);
        actorPoints[10].localPosition += new Vector3(sing_11.x, sing_11.y, sing_11.z);
        actorPoints[11].localPosition += new Vector3(sing_12.x, sing_12.y, sing_12.z);

        // 应用旋转
        actorPoints[0].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, rotate, 0);
        actorPoints[1].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, rotate, 0);
        actorPoints[2].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, rotate, 0);
        actorPoints[3].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, rotate, 0);
        actorPoints[4].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, rotate, 0);
        actorPoints[5].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, rotate, 0);

        actorPoints[6].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, -rotate, 0);
        actorPoints[7].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, -rotate, 0);
        actorPoints[8].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, -rotate, 0);
        actorPoints[9].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, -rotate, 0);
        actorPoints[10].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, -rotate, 0);
        actorPoints[11].transform.Find("actorPoint").localRotation = Quaternion.Euler(0, -rotate, 0);

        // 应用缩放
        actorPoints[0].transform.Find("actorPoint").localScale = new Vector3(sing_scale_1 * scale, sing_scale_1 * scale, sing_scale_1 * scale);
        actorPoints[1].transform.Find("actorPoint").localScale = new Vector3(sing_scale_2 * scale, sing_scale_2 * scale, sing_scale_2 * scale);
        actorPoints[2].transform.Find("actorPoint").localScale = new Vector3(sing_scale_3 * scale, sing_scale_3 * scale, sing_scale_3 * scale);
        actorPoints[3].transform.Find("actorPoint").localScale = new Vector3(sing_scale_4 * scale, sing_scale_4 * scale, sing_scale_4 * scale);
        actorPoints[4].transform.Find("actorPoint").localScale = new Vector3(sing_scale_5 * scale, sing_scale_5 * scale, sing_scale_5 * scale);
        actorPoints[5].transform.Find("actorPoint").localScale = new Vector3(sing_scale_6 * scale, sing_scale_6 * scale, sing_scale_6 * scale);

        actorPoints[6].transform.Find("actorPoint").localScale = new Vector3(-sing_scale_1 * scale, sing_scale_1 * scale, sing_scale_1 * scale);
        actorPoints[7].transform.Find("actorPoint").localScale = new Vector3(-sing_scale_2 * scale, sing_scale_2 * scale, sing_scale_2 * scale);
        actorPoints[8].transform.Find("actorPoint").localScale = new Vector3(-sing_scale_3 * scale, sing_scale_3 * scale, sing_scale_3 * scale);
        actorPoints[9].transform.Find("actorPoint").localScale = new Vector3(-sing_scale_4 * scale, sing_scale_4 * scale, sing_scale_4 * scale);
        actorPoints[10].transform.Find("actorPoint").localScale = new Vector3(-sing_scale_5 * scale, sing_scale_5 * scale, sing_scale_5 * scale);
        actorPoints[11].transform.Find("actorPoint").localScale = new Vector3(-sing_scale_6 * scale, sing_scale_6 * scale, sing_scale_6 * scale);
