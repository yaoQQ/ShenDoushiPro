...
public class ActorPointTools4 : MonoBehaviour
{
    private const int POINT_COUNT = 10; // 点位数量
    ...
    public void LogicPoint()
    {
        ...
        actorPoints[1].localPosition = new Vector3(-column_inside.x - row_3.x, column_inside.y + row_3.y, column_inside.z + row_3.z);
        actorPoints[2].localPosition = new Vector3(-column_outside.x - row_1.x, column_outside.y + row_1.y, column_outside.z + row_1.z);
        actorPoints[3].localPosition = new Vector3(-column_outside.x - row_2.x, column_outside.y + row_2.y, column_outside.z + row_2.z);
        actorPoints[4].localPosition = new Vector3(-column_outside.x - row_3.x, column_outside.y + row_3.y, column_outside.z + row_3.z);

        actorPoints[5].localPosition = new Vector3(column_inside.x + row_1.x, column_inside.y + row_1.y, column_inside.z + row_1.z);
        actorPoints[6].localPosition = new Vector3(column_inside.x + row_3.x, column_inside.y + row_3.y, column_inside.z + row_3.z);
        actorPoints[7].localPosition = new Vector3(column_outside.x + row_1.x, column_outside.y + row_1.y, column_outside.z + row_1.z);
        actorPoints[8].localPosition = new Vector3(column_outside.x + row_2.x, column_outside.y + row_2.y, column_outside.z + row_2.z);
        actorPoints[9].localPosition = new Vector3(column_outside.x + row_3.x, column_outside.y + row_3.y, column_outside.z + row_3.z);
        ...
        actorPoints[5].localPosition += new Vector3(-sing_1.x, sing_1.y, sing_1.z);
        actorPoints[6].localPosition += new Vector3(-sing_2.x, sing_2.y, sing_2.z);
        actorPoints[7].localPosition += new Vector3(-sing_3.x, sing_3.y, sing_3.z);
        actorPoints[8].localPosition += new Vector3(-sing_4.x, sing_4.y, sing_4.z);
        actorPoints[9].localPosition += new Vector3(-sing_5.x, sing_5.y, sing_5.z);
        ...
        actorPoints[5].localScale = new Vector3(-sing_scale_1 * scale, sing_scale_1 * scale, sing_scale_1 * scale);
        actorPoints[6].localScale = new Vector3(-sing_scale_2 * scale, sing_scale_2 * scale, sing_scale_2 * scale);
        actorPoints[7].localScale = new Vector3(-sing_scale_3 * scale, sing_scale_3 * scale, sing_scale_3 * scale);
        actorPoints[8].localScale = new Vector3(-sing_scale_4 * scale, sing_scale_4 * scale, sing_scale_4 * scale);
        actorPoints[9].localScale = new Vector3(-sing_scale_5 * scale, sing_scale_5 * scale, sing_scale_5 * scale);
