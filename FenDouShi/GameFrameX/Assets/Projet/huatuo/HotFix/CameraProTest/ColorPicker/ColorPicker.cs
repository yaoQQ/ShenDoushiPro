...
public class ColorPicker : MonoBehaviour
{
    ...
    public Action<Color,bool> OnColorChange;
    private bool _isBaseColor = true;
    public Color Color
    {
        get { return m_Color; }
        set
    ...
    private void resetColorPicker()
    {
       ...
       // Debug.Log("<color='red'>resetColorPicker() Color=" + Color + "</color>");
    }
    private void SetColorChange(Color currColor)
    {
        if (m_mainColorTape.color != currColor)
        {
            m_mainColorTape.color = Color;
            if (OnColorChange != null)
            {
                OnColorChange(Color, this._isBaseColor);
            }
        }
    }
    ...
    void Start()
    {
        ...
        m_BgBtn = m_transform.Find("Bg").GetComponent<Button>();
        ...
        m_BgBtn.onClick.AddListener(Hide);
    }
    public void Show(bool isBaseColor)
    {
        _isBaseColor = isBaseColor;
    ...
    public void SuckColorByNonius(Vector3 noniusPos)
    {
        ...
        SetColorChange(Color);
        //  Debug.Log("<color='red'>SuckColorByNonius() Color=" + Color+"</color>");
    }
