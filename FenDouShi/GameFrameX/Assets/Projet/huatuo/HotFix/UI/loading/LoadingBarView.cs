...
public class LoadingBarView
{
    ...
    private ImageWidget progress_bg;
    ...
    public void Init(GameObject go, GameObject container)
    {
        ...
        Transform loadView = gameObject.transform.Find("loading");
        loadView.gameObject.SetActive(true);
        contentTxt = gameObject.transform.Find("loading/progress_text").GetComponent<TextWidget>();
        progress_bg = loadView.transform.Find("progress_bg").GetComponent<ImageWidget>();
        // var progressText= contentTxt = gameObject.transform.Find("progress_window/progress_text").GetComponent<TextWidget>();
        contentTxt.text = "";
      //  progressText.text = "";
    ...
    public void SetProgress(float value)
    {
        ...
        progress_bg.rectTransform.sizeDelta = new Vector2(value * 637, 38);
    }
    ...
    public void Show(bool sign)
    {
        ...
        gameObject.transform.parent.gameObject.SetActive(sign);
    }
