...
/// </summary>
public class GameGunData
{
    public GunType gunType;//GunType.None是属性对象，其它为武器对象
    ...
    public GameGunData()
    {
        Debug.Log("GameGunData2()");
    }
    public void clone(GameGunData other)
    {
    ...
    public void setLevel(int currLevel)
    {
        ...
        if (this.level > GameGunData.levelMax)
        {
            this.level = GameGunData.levelMax;
        }
