...
namespace UIWidget
{
    public class GridRecycleScrollWidget : ScrollPanelWidget
    {
        ...
        public void SetCellDataObjet<T>(List<T> p_dataList, Action<GameObject, object, int> p_onUpdateCellData, bool resetPos = false)
        {

            //Logger.PrintDebug("2222@@@@@@@@@@@@@SetCellData1111 p_dataList=" + dataLists);
            //List<object> p_dataList = dataLists as List<object>;
            //Logger.PrintDebug("2222@@@@@@@@@@@@@SetCellData22222 p_dataList.count="+ p_dataList.Count);
            if (p_dataList != null && p_dataList.Count > cellItemArr.Length - 2)
            {
        ...
        //{
        //    Logger.PrintDebug("1111@@@@@@@@@@@@@SetCellData1111111");
        //    List<object> objectLists = new List<object>();
        //    objectLists.AddRange(p_dataList as List<IConfig>);
        //    SetCellDataObjet(objectLists, p_onUpdateCellData, resetPos);
        //}
        private void ToObjectList()
        {
