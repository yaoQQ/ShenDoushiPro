...
namespace UIWidget
{
    public class CellRecycleScrollWidget : ScrollPanelWidget
    {
        ...
        public void SetCellData<T>(List<T> pDataList, Action<GameObject, object, int, int> pOnUpdateCellData, bool resetPos = false)
        {
        ...
        public void HoldAppearScroll(float scale)
        {
            if (scrollRect.vertical)
            {
                ...
                else
                {
                    ...
                    tween = Tween2.AutoManagerTween(scrollRect.content.gameObject, 0.35f);
        ...
        {
            scrollRect.content.gameObject.SetActive(false);
            tween = Tween2.AutoManagerTween(scrollRect.gameObject, holdTime);
