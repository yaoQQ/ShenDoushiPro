...
namespace UIWidget
{
    public class ButtonWidget : UIBaseWidget
    {
        ...
        {
            Debug.Log("ButtonWidget this.exportSign)=" + this.exportSign);
        }
        public void testButton2()
        {
            Debug.Log("ButtonWidget testButton2 this.exportSign)=" + this.exportSign);
        }
        ...
        public void SetPng(Sprite sprite, bool isSetNative = false)
        {
            if (this.Btn == null || this.Btn.image == null)
                return;
            this.Btn.image.sprite = sprite;
            if (isSetNative)
            {
                this.Btn.image.type = Image.Type.Simple;
                this.Btn.image.SetNativeSize();
            }
        }
