...
public abstract class BaseEditView  {
    ...
    protected void DrawCommon(EditorWindow window, GameObject go, UIBaseWidget widget)
    {
        ...
        UIAlign2 align = UITools2.GetWidgetAlign(rt);
        align = (UIAlign2)EditorGUILayout.EnumPopup("对齐align", align, GUILayout.ExpandWidth(true));
        UITools2.SetWidgetAlign(rt, align);
