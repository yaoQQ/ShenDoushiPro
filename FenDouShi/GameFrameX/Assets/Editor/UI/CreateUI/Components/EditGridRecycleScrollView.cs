...
public class EditGridRecycleScrollView : BaseEditView
{
    ...
    public override void Render(EditorWindow window, UIBaseWidget widget)
    {
        ...
        UITools2.SetWidgetAlign(gridRecycleScrollWidget.scrollRect.content, UIAlign2.Top_Left);
        ...
        UIAlign2 align = UITools2.GetWidgetAlign(gridRecycleScrollWidget.scrollRect.content);
        align = (UIAlign2)EditorGUILayout.EnumPopup("容器对齐方式 ", align, GUILayout.ExpandWidth(true));
        UITools2.SetWidgetAlign(gridRecycleScrollWidget.scrollRect.content, align);
        ...
        if (gridRecycleScrollWidget.cellItemArr != null && gridRecycleScrollWidget.cellItemArr[0] != null)
        {
            if (GUILayout.Button("自助生成", new GUILayoutOption[] { GUILayout.Width(42f), GUILayout.ExpandWidth(true) }))
            {
                ...
                UITools2.SetWidgetAlign(rt, UIAlign2.Top_Left);
                ...
                for (i = 0; i < rowMaxValue; i++)
                {
                    for(int j=0;j< columnMaxValue; j++)
                    {
                        ...
                        UITools2.SetWidgetAlign(dupRT, UIAlign2.Top_Left);
