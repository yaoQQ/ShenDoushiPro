...
public class EditCellRecycleScrollView : BaseEditView
{
    ...
    public override void Render(EditorWindow window, UIBaseWidget widget)
    {
        ...
        //UITools2.SetWidgetAlign(cellRecycleScrollWidget.scrollRect.content, UIAlign2.Top_Left);
        ...
        UIAlign2 align = UITools2.GetWidgetAlign(cellRecycleScrollWidget.scrollRect.content);
        align = (UIAlign2)EditorGUILayout.EnumPopup("容器对齐方式 ", align, GUILayout.ExpandWidth(true));
        UITools2.SetWidgetAlign(cellRecycleScrollWidget.scrollRect.content, align);
