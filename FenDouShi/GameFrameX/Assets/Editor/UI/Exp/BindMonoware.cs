...
public static class BindMonoware
{
    ...
    static void AutoBindMonoByApply()
    {
        ...
        //            return;
        //        }
        //        PrefabAssetType pType = PrefabUtility.GetPrefabAssetType(selectGo);
    ...
    static GameObject GetPrefabInstanceParent(GameObject go)
    {
        ...
        PrefabAssetType pType = PrefabUtility.GetPrefabAssetType(go);
        if (pType != PrefabAssetType.Regular)
        {
            return null;
        }
        ...
        pType = PrefabUtility.GetPrefabAssetType(go.transform.parent.gameObject);
        if (pType != PrefabAssetType.Regular)
        {
            return go;
        }
