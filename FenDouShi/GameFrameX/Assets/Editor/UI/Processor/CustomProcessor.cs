...
public class CustomProcessor : AssetPostprocessor
{
    ...
    void OnPreprocessTexture()
    {
        ...
        if (nameArr.Length >= 3)
        {
            Debug.Log("OnPreprocessTexture() nameArr[2]=" + nameArr[2]);
        ...
        iPhoneSettings.compressionQuality = (int)UnityEditor.TextureCompressionQuality.Normal;// (int)TextureCompressionQuality.Best;
