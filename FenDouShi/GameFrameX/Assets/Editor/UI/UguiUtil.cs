...
public static class UguiUtil
{
    ...
    static public SliderWidget AddSlider(GameObject p_parent, bool isHandle = true)
    {
        ...
        GameObject num = CreateUIObject("num", root);
        GameObject title = CreateUIObject("tile", root);
        Text numTex =num.AddComponent<Text>();
        numTex.fontSize = 14;
        numTex.rectTransform.sizeDelta = new Vector2(50, 50);
        numTex.transform.localPosition = new Vector3(0, 0, 0);
        numTex.alignment = TextAnchor.MiddleCenter;
        numTex.text = "0";
        numTex.color = Color.black;
        numTex.raycastTarget = false;
        Text titleTex = title.AddComponent<Text>();
        titleTex.fontSize = 21;
        titleTex.rectTransform.sizeDelta = new Vector2(100, 100);
        titleTex.transform.localPosition = new Vector3(-135, 0, 0);
        titleTex.alignment = TextAnchor.MiddleRight;
        titleTex.text = "tile";
        titleTex.color = Color.black;
        titleTex.raycastTarget = false;
        // Background
