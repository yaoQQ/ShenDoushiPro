...
public class CommonPathUtils
{
    ...
    public static string m_cdnRootPath = string.Empty;
    ...
    public static string getLoadRootDir(string packageName, string relativePath)
    {
        ...
        {
            Debug.Log("<color=blue> packageName=" + packageName + "</color>");
            Debug.Log("<color=blue> CommonUtils.isIncludeGame=" + CommonUtils.isIncludeGame + "</color>");
            if (packageName == "BasePackage" || CommonUtils.isIncludeGame)
            {
                Debug.Log("<color=blue> isSkipUpdate=" + CommonUtils.isSkipUpdate + "</color>");
                ...
                else
                {
                    ...
                    //if (resItem == null)
                    //{
                    //    Debug.Log("<color=red> resItem=null" + "</color>");
                    //    return "";

                    //}
                    //Debug.Log("<color=blue> resItem.isUpdate=" + resItem.isUpdate + "</color>");
                    //if (resItem.isUpdate)
                    //    return CommonUtils.ConnectStrs(PERSISTENT_DATA_ROOT_PATH, "/base/res/");
                    //else
                        return CommonUtils.ConnectStrs(STREAMING_ASSETS_ROOT_PATH, "/base/res/");
