...
public class AddressableLoadManager : SingleMonobehaviour<AddressableLoadManager>
{
    ...
    private string OutSpacePackage = "OutSpacePackage";//游戏包
    private AsyncOperationHandle<GameObject> loadHandle = new AsyncOperationHandle<GameObject>();

    private Transform _loginCanvas;
    //private void testClient()
    //{
    //    string baseUI = "https://assetstreaming-content.unity.cn/client_api/v1/buckets/4bce09f3-b786-47e4-a282-30bae25b918a/release_by_badge/latest/content/catalog_1.json";//pc2
