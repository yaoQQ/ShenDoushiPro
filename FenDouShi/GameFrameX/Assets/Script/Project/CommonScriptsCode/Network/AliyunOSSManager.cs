...
{
   // const string accessKeyId = "LTAI4FkQ3G2rds3E5GM6Y6kM";
   // const string accessKeySecret = "WEhuajVSdW1rZzNjWGhrU2pLUmpMMVhBRUl0MFZR";
   ...
   // /// 正式服的Bucket
   // /// </summary>
   // private const string BucktNameOfficial = "yaomvp";
   // /// <summary>
   // /// 开发服的Bucket
   // /// </summary>
   // private const string BucketNameDevelop = "yaomvp";
   // private string m_bucketName = "yaomvp";
   // void Awake()
   // {
   //     m_instance = this;
   //     this.localSaveRootDir = string.Format("{0}/{1}/{2}", CommonPathUtils.PERSISTENT_DATA_ROOT_PATH, "aliyunFiles", "Image");
   // }
   ...
   //     {
   //         string path = CommonUtils.ConnectStrs("http://yaomvp.oss-cn-shenzhen.aliyuncs.com/", "GameIcon/animal_b1.jpg");
   //        DownloadImage(path, 1, (textrue, str) => {
   //            Debug.Log("DownloadImage textrue="+ textrue);
   //            Debug.Log("DownloadImage str=" + str);
   //        });
   //     }
   // }
   ...
   // {
   //     Debug.Log("LoadHttp url=" + url);
   //     WWW www = new WWW(url);
   //     yield return www;
   //     Debug.Log("LoadHttp www.error=" + www.error);
   //     if (www != null && string.IsNullOrEmpty(www.error))
   //     {
   //         if (finishCallback != null)
   //         {
   ...
   //         var noExtensionUrl =CommonPathUtils.SERVER_ROOT_PATH+ url;
