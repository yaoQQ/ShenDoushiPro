...
public class UIViewStack
{
    ...
    public static void Push(int viewEnum, System.Object msg, Action openCallback)
    {
        //取消关闭新入栈的界面
    ...
    /// <param name="msg"></param>
    /// <param name="openCallback"></param>
    public static void Push(string viewEnum, System.Object msg, Action openCallback)
    {
