...
public class AddressableBundleAssetNode : AssetNode
{
    ...
    {
        Logger.PrintColor("white", "生成AddressableBundleAssetNode assetType=" + assetType+" packageName =" + packageName+ " relativePath="+ relativePath);
    }
    public void LoadFromFileAsync()
    {
        ...
        switch (assetType)
        {
            case AssetType.FairyUI:
                boundleOper = Addressables.LoadAssetAsync<TextAsset>(packageName+ "_fui");
                updateFairyGUIState();
                break;
            case AssetType.UI:
    ...
    private void updateFairyGUIState()
    {
