...
namespace FairyGUI
{
    ...
    public class UIConfig : MonoBehaviour
    {
        ...
        [SerializeField]
        [Header("是否打印协议数据")]
        public  bool _isShowNetDebug = true;
        public static bool isShowNetDebug { get { return instance._isShowNetDebug; } }

        [SerializeField]
        [Header("是否默认加载全部界面(在登入界面调试)")]
        public bool _isShowAllWinowDebug = false;
        public static bool isShowAllWinowDebug { get { return instance._isShowAllWinowDebug; } }
