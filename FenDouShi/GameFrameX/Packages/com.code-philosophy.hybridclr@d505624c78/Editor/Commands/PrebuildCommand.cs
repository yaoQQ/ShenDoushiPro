...
namespace HybridCLR.Editor.Commands
{
    public static class PrebuildCommand
    {
        ...
        {
            Debug.Log($"<color='white'>GenerateAll() Start</color>");
            ...
            Debug.Log("<color='yellow'>=============GenerateAll() Success!!! End=================</color>");

            AssetBundleBuildCommand.BuildSceneAssetBundleActiveBuildTarget();
        }
    }
}
